...
<div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
    ...
    <div class="w3-dropdown-hover">
        ...
        <div class="w3-dropdown-content w3-bar-block">
            <a href="tambahartikeluser.php" class="w3-bar-item w3-button">Tambah Artikel</a>
            <a href="dataartikeluser.php" class="w3-bar-item w3-button">Data Artikel</a>
        </div>
    </div>
    <div class="w3-dropdown-hover">
        <button class="w3-button">Kategori</button>
        <div class="w3-dropdown-content w3-bar-block">
            <a href="tambahkategoriuser.php" class="w3-bar-item w3-button">Tambah Kategori</a>
            <a href="kategoriuser.php" class="w3-bar-item w3-button">Data Kategori</a>
        </div>
    </div>
...
<div class="w3-teal">
    ...
    <div class="w3-container">
        <h1 class="welcome-title">Welcome My Blog</h1>
    </div>
</div>
<br><br><br>
